...
![](documentation/images/am_i_responsive_mockup.png)
...
The navigation bar features on all three pages, it includes a logo which links back to the home page when clicks. There are then three links one for the home page, the membership page and the free trial page. The user will know which page they are on at all times with the active botton border.
...
* A Lighthouse report was ran through Chrome dev tools, a hight accessibility score was obtained. Performance score a little low due to image types.
...
![](documentation/images/Lighthouse_report_membership_page.png)

**Free Trial Page**

![](documentation/images/Lighthouse_report_free_trial_page.png)

### Performance test on various devices and browsers

I tested the website on the following devices and browsers

* Safari on iPad (7th gen) and iPhone (11 &13)
* Edge on desktop
* Chrome on desktop

All pages, features & links worked and responsed as they should on all the devices/browsers mentioned above.
...
### Unfixed Bugs
* Too much of a gap between div and footer on some devices on index page
* Not responding as well as we would like on some android and smaller mobile devices
* Parts of the footer disapper on some mobile devices
